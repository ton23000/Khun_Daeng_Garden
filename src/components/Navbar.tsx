                ...
                <div className={`${styles.bottomBar} ${showMobileMenu ? styles.showMobileMenu : ''}`}>
                    <div className={`container ${styles.bottomBarContainer}`}>
                        ...
                        <div className={styles.socialAdmin}>
                            ...
                            <a href="https://www.facebook.com/kittitusjupraja?_rdc=1&_rdr#" target="_blank" rel="noopener noreferrer" style={{ color: '#6b7280', display: 'flex', alignItems: 'center', transition: 'color 0.2s' }} title="Facebook">
