          ...
          >
              ...
              >
                <input
                  ...
                  value={
                    color === "transparent"
                      ? "#000000"
                      : color && /^#[0-9A-Fa-f]{6}$/i.test(color)
                        ? color
                        : "#000000"
                  }
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "4px",
                    background: color === "transparent" ? "#e5e7eb" : "white",
                    cursor: "pointer",
                  }}
                >
                  ไม่มีสี
              ...
              >
                <input
                  ...
                  value={
                    bgColor === "transparent"
                      ? "#ffffff"
                      : bgColor && /^#[0-9A-Fa-f]{6}$/i.test(bgColor)
                        ? bgColor
                        : "#ffffff"
                  }
                  ...
                  style={{
                    ...
                    padding: 0,
                    border: "none",
                    opacity: bgColor === "transparent" ? 0.3 : 1,
                  }}
                />
                <button
                  type="button"
                  onClick={() =>
                    setBgColor(
                      bgColor === "transparent" ? "#ffffff" : "transparent",
                    )
                  }
                  style={{
                    fontSize: "0.75rem",
                    ...
                    border: "1px solid #d1d5db",
                    borderRadius: "4px",
                    background: bgColor === "transparent" ? "#e5e7eb" : "white",
                    cursor: "pointer",
                  }}
                >
                  ไม่มีสี
            ...
            >
              ...
              <input
                ...
                placeholder="เช่น 2rem หรือ 32px"
                style={{
                  padding: "0.25rem 0.5rem",
                  border: "1px solid #d1d5db",
                  borderRadius: "4px",
  ...
  return (
    <Tag
      ...
      style={{
        ...
        cursor: "default",
        display:
          renderAs === "span" || renderAs === "a" ? "inline-block" : undefined,
        ...appliedStyle,
      }}
