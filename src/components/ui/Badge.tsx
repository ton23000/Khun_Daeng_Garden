...
export function Badge({ className = '', variant = 'default', ...props }: BadgeProps) {
    ...
    switch (variant) {
        case 'default':
            variantStyles = "border-transparent bg-primary text-primary-foreground hover:bg-primary/80 bg-green-600 text-white";
            break;
        case 'secondary':
            variantStyles = "border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 bg-gray-100 text-gray-900";
            break;
        case 'destructive':
