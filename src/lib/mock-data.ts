export const MOCK_TREES = [
  {
    ...
    images: JSON.stringify([
      "/images/products/system_plants/kwak_phra_phrom/kwak_phra_phrom_1.jpg",
    ]),
    category: "ไม้มงคล",
    status: "AVAILABLE",
    stock: 19,
  ...
  },
  {
    ...
    images: JSON.stringify([
      "/images/products/system_plants/khum_phai/khum_phai_1.jpg",
    ]),
    category: "ไม้มงคล",
    status: "AVAILABLE",
    stock: 15,
  ...
  },
  {
    ...
    originalPrice: null,
    description:
      "ไม้ประดับใบสวย ทรงพุ่มสง่า เหมาะสำหรับตกแต่งห้องนั่งเล่นหรือมุมทำงาน",
    images: JSON.stringify([
      "/images/products/system_plants/moradok_lok/moradok_lok_1.jpg",
    ]),
    category: "ไม้ประดับ",
    status: "AVAILABLE",
    stock: 8,
...
export const MOCK_SITE_SETTINGS = {
  ...
  hero_subtitle:
    "ขณะนี้เว็บไซต์กำลังแสดงผลในโหมดตัวอย่าง (Demo) เนื่องจากไม่สามารถเชื่อมต่อฐานข้อมูลได้",
