...
export default function MyOrdersPage() {
  ...
  const handleSlipUpload = async (bookingId: string, file: File) => {
    console.log("🔵 handleSlipUpload called", {
      bookingId,
      fileName: file?.name,
    });
                        ...
                        >
                          ...
                          >
                            ...
                            <p style={{ marginBottom: "0.25rem" }}>
                              ธนาคาร: <strong>ไทยพาณิชย์</strong>
                            </p>
                            <p style={{ marginBottom: "0.25rem" }}>
                              เลขที่บัญชี: <strong>123-456-7890</strong>
                            </p>
                            <p style={{ marginBottom: "0.25rem" }}>
                              ชื่อบัญชี: <strong>คุณแดงการ์เด้น</strong>
                            </p>
                            <p
                              style={{
                                marginTop: "0.5rem",
                      ...
                      {booking.slipUrl && (
                        ...
                        >
                          ...
                          <img
                            ...
                            onClick={() =>
                              window.open(booking.slipUrl!, "_blank")
                            }
                          />
                          <p
                            style={{
