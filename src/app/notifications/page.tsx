                        ...
                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                            ...
                            <button
                                ...
                                style={{
                                    padding: '0.5rem 1rem',
                                    borderRadius: '0.375rem',
                                    border: filter === 'unread' ? '2px solid #166534' : '1px solid #d1d5db',
                            ...
                            <button
                                ...
                                style={{
                                    padding: '0.5rem 1rem',
                                    borderRadius: '0.375rem',
                                    border: filter === 'read' ? '2px solid #166534' : '1px solid #d1d5db',
                            ...
                            <CardContent style={{ padding: '1.5rem' }}>
                                <div style={{ display: 'flex', gap: '1rem', alignItems: 'start' }}>
                                    ...
                                    <div style={{
                                        ...
                                        backgroundColor: notification.read ? '#f3f4f6' : '#dcfce7',
                                        borderRadius: '50%'
                                    }}>
                                    ...
                                    <div style={{ flex: 1 }}>
                                        ...
                                        <div style={{
                                            ...
                                            <span>📅 {new Date(notification.date).toLocaleString('th-TH')}</span>
                                            {!notification.read && (
                                                <span style={{
            ...
            {filteredNotifications.length > 0 && (
                <div style={{
                    ...
                    <p style={{ fontSize: '0.875rem', color: '#6b7280' }}>
                        ...
                        {filter !== 'all' && ` (กรอง: ${filter === 'unread' ? 'ยังไม่อ่าน' : 'อ่านแล้ว'})`}
                    </p>
                </div>
            )}
        </div>
