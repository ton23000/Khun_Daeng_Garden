...
function ShopContent() {
  ...
  const processTreeData = (data: Tree[]) => {
    ...
    const uniqueCategories = Array.from(
      new Set(data.map((t: Tree) => t.category).filter(Boolean)),
    ).sort() as string[];
                ...
                >
                  ...
                  >
                    ...
                    <p
                      style={{
                        fontSize: "0.9rem",
                        color: tree.isPromotion ? "#dc2626" : "#6b7280",
                        fontWeight: tree.isPromotion ? "bold" : "normal",
      ...
      {filteredTrees.length === 0 && (
        <div style={{ textAlign: "center", padding: "3rem", color: "#6b7280" }}>
          <p style={{ fontSize: "1.125rem" }}>
            ไม่พบรายการต้นไม้ที่ตรงกับเงื่อนไข
          </p>
