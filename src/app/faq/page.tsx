            ...
            <ScrollAnimation animation="fade-up" delay={100}>
                ...
                <div style={{ marginBottom: '3rem' }}>
                    ...
                    <FAQItem 
                        ...
                        answer={
                            <p>เรารับประกันต้นไม้ทุกต้น <strong>7 วัน</strong> หลังจากได้รับ หากพบว่าต้นไม้มีปัญหา เหี่ยวเฉา สามารถแจ้งเราพร้อมแนบรูปถ่าย เรายินดีดูแลให้ฟรีครับ</p>
                        } 
                    />
                    <FAQItem 
                        question="ต้นไม้ที่ได้รับจะไม่ตรงปกใช่ไหม?" 
                        answer={
                            <p>สวนคุณแดงรับประกันความพึงพอใจ ต้นไม้จะตรงกับรูปหรือใกล้เคียงที่สุด หากลูกค้าต้องการดูต้นจริงก่อนรับ สามารถแจ้งแอดมินได้เลยครับ</p>
                        } 
                    />
                </div>
                ...
                <div style={{ marginBottom: '3rem' }}>
                    ...
                    <FAQItem 
                        ...
                        answer={
                            <p>ต้นไม้แต่ละชนิดมีความต้องการแสงแดดและน้ำที่แตกต่างกัน ทีมงานพร้อมให้คำปรึกษาหลังการขายฟรี ทักถามมาได้ทั้ง LINE และโทรศัพท์ตลอดเวลาครับ</p>
                        } 
                    />
                    <FAQItem 
                        question="สามารถมาดูต้นไม้หน้าร้านได้ไหม?" 
                        answer={
                            <p>ได้เลยครับ! ยินดีต้อนรับทุกวัน <strong>08:00 – 17:00 น.</strong> ที่ 383 ถ.กาญจนวินิช ต.พะวง อ.เมือง จ.สงขลา สั่งออนไลน์แล้วมารับที่สวนก็ได้ครับ</p>
                        } 
                    />
                </div>
