...
export async function GET() {
  try {
    console.log(
      "API: Syncing all tree categories into the Category table and fixing tags...",
    );
    const results = [];
    ...
    return NextResponse.json({
      success: true,
      message: "Synced categories and fixed tags successfully",
      logs: results,
      totalUnique: uniqueCategories.size,
    });
  } catch (error: unknown) {
