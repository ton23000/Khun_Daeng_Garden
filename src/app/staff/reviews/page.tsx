    ...
    <div>
      ...
      >
        ...
        <span style={{ fontSize: "0.875rem", color: "#6b7280" }}>
          ทั้งหมด {reviews.length} | โชว์หน้าแรก{" "}
          {reviews.filter((r) => r.isFeatured).length} | ซ่อน{" "}
            ...
            return (
              <Card
                ...
                style={{
                  ...
                  borderLeft: `4px solid ${review.hidden ? "#ef4444" : "#1d4ed8"}`,
                }}
              >
                      ...
                      <Button
                        ...
                        style={{
                          borderColor: review.isFeatured
                            ? "#d97706"
                            : "#bfdbfe",
                          color: review.isFeatured ? "#d97706" : "#1d4ed8",
                          fontSize: "0.75rem",
                        }}
                      >
