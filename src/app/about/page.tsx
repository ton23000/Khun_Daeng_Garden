      ...
      <div className={styles.sectionContainer}>
        <ScrollAnimation animation="fade-up" delay={100}>
          <section>
            ...
            <p className={styles.bodyText}>
              ร้านสวนคุณแดง เริ่มต้นจากความรักในการปลูกต้นไม้
              และสะสมพันธุ์ไม้สวยงาม ทั้งไม้มงคล ไม้ดอก และไม้ประดับ
              เราคัดสรรต้นไม้คุณภาพดี แข็งแรง
              เพื่อส่งต่อความสุขสีเขียวให้กับลูกค้าทุกท่าน ด้วยประสบการณ์กว่า 10
              ปี เราพร้อมให้คำแนะนำในการดูแลรักษา
              เพื่อให้ต้นไม้ของคุณเติบโตอย่างสวยงาม
            </p>
          </section>
        </ScrollAnimation>
        ...
        <ScrollAnimation animation="fade-up" delay={200}>
          <section className={styles.highlightSection}>
            <h2 className={styles.highlightTitle}>ทำไมต้องเลือกสวนคุณแดง?</h2>
            <ul className={styles.featureList}>
              <li>ประสบการณ์ดูแลต้นไม้และจัดสวนมายาวนานกว่า 10 ปี</li>
              <li>มีหน้าร้านจริงให้เยี่ยมชมและเลือกซื้อต้นไม้ได้ทุกวัน</li>
              <li>จำหน่ายต้นไม้สุขภาพดี แข็งแรง คัดสรรจากสวนที่ได้มาตรฐาน</li>
              <li>พร้อมให้คำปรึกษาวิธีการปลูกและดูแลต้นไม้หลังการซื้อ ฟรี!</li>
              <li>รีวิวความประทับใจจากลูกค้าจริงการันตีคุณภาพ</li>
            </ul>
          </section>
        </ScrollAnimation>
