            ...
            <div className="container" style={{ padding: '4rem 1rem', display: 'flex', justifyContent: 'center' }}>
                <Card style={{ width: '100%', maxWidth: '500px' }}>
                    <CardHeader style={{ textAlign: 'center' }}>
                        ...
                        <CardTitle style={{ marginBottom: '0.5rem' }}>ตรวจสอบอีเมลของคุณ</CardTitle>
                    ...
                    <CardContent>
                        <div style={{
                            ...
                            <ol style={{ marginLeft: '1.25rem', fontSize: '0.875rem', color: '#334155' }}>
                                <li>เปิดอีเมลของคุณที่ <strong>{email}</strong></li>
                        ...
                        <div style={{ marginTop: '1rem', textAlign: 'center', fontSize: '0.875rem' }}>
                            <Link href="/login" style={{ color: 'var(--primary)' }}>← กลับไปหน้าเข้าสู่ระบบ</Link>
                        </div>
                    </CardContent>
                </Card>
            </div>
