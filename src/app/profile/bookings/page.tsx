    ...
    <div className="container" style={{ padding: "2rem 1rem" }}>
                ...
                <CardContent style={{ padding: "1.5rem" }}>
                  <div className="responsive-grid">
                          ...
                          <div key={idx} style={{ textAlign: "center" }}>
                            <img
                              ...
                              style={{
                                width: "100%",
                                maxWidth:
                                  booking.items.length > 1 ? "100px" : "150px",
                                maxHeight: "150px",
                                objectFit: "contain",
                                margin: "0 auto",
                    ...
                    <div>
                      ...
                      {booking.items.map((item, idx) => {
                        const isReviewed = booking.reviews?.some(
                          (r) => r.treeId === item.treeId,
                        );
                        ...
                        >
                          ...
                          >
                            ...
                            <p style={{ marginBottom: "0.25rem" }}>
                              ธนาคาร: <strong>ธนาคารกรุงเทพ (BBL)</strong>
                            </p>
                            <div
                              style={{
                                display: "flex",
                            ...
                            <p style={{ marginBottom: "0.25rem" }}>
                              ชื่อบัญชี: <strong>สวนคุณแดง</strong>
                            </p>
                            <p
                              style={{
                                marginTop: "0.5rem",
                        ...
                        {(() => {
                          ...
                          if (!rawSlip) {
                            return canUploadSlip(booking.status) ? (
                              <div>
                                ...
                                >
                                  กรุณาแนบสลิปการโอนเงิน (สูงสุด 3 รูป)
                                </p>
                                <input
                                  ref={(el) => {
                                ...
                                <Button
                                  ...
                                  onClick={() =>
                                    document
                                      .getElementById(`file-${booking.id}`)
                                      ?.click()
                                  }
                          ...
                          return (
                            <div>
                              ...
                              >
                                ✅ แนบสลิปแล้ว {slipUrls.length} รูป
                              </p>
                              <div
                                style={{
                                  display: "flex",
                      ...
                      {[
                        ...
                        <div style={{ marginTop: "1rem", textAlign: "right" }}>
                          <Button
                            ...
                            onClick={async () => {
                              if (!confirm("ยืนยันที่จะยกเลิกออเดอร์นี้?"))
                                return;
                              try {
      ...
      <SlipViewer
        ...
        onDelete={
          viewingSlip &&
          canUploadSlip(
            bookings.find((b) => b.id === viewingSlip.bookingId)?.status ?? "",
          )
            ? (idx) =>
                handleDeleteSlip(viewingSlip.bookingId, viewingSlip.urls, idx)
            : undefined
        }
      />
