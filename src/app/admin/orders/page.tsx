...
export default function OrdersPage() {
  ...
  useEffect(() => {
    if (bookingId && bookings.length > 0) {
      const targetBooking = bookings.find(
        (b) => b.id === bookingId || b.refCode === bookingId,
      );
      if (targetBooking) {
  ...
  // History bookings (latest 5 cancelled or completed)
  ...
  return (
    <div>
      ...
      >
        <h2
          style={{ fontSize: "1.5rem", fontWeight: "bold", color: "#e11d48" }}
        >
          จัดการออเดอร์
        </h2>
        <div className="actions-wrapper">
          ...
          <div className="filter-buttons">
              ...
              style={{
                backgroundColor:
                  viewMode === "all" && !statusFilter
                    ...
                    : "transparent",
                color:
                  viewMode === "all" && !statusFilter ? "white" : "#374151",
                borderColor:
                  viewMode === "all" && !statusFilter ? "#e11d48" : "#e5e7eb",
                display: "flex",
                justifyContent: "center",
              }}
            >
              ...
              style={{
                backgroundColor:
                  statusFilter === "PENDING_APPROVAL"
                    ...
                    : "transparent",
                borderColor:
                  statusFilter === "PENDING_APPROVAL" ? "#f59e0b" : "#e5e7eb",
                color: "#d97706",
                display: "flex",
                justifyContent: "center",
                alignItems: "center",
            ...
            <Button
              ...
              style={{
                backgroundColor:
                  viewMode === "by-customer" ? "#22c55e" : "transparent",
                    ...
                    style={{
                      ...
                      border:
                        selectedCustomer === customer
                          ...
                          : "1px solid #d1d5db",
                      backgroundColor:
                        selectedCustomer === customer ? "#dcfce7" : "white",
                      cursor: "pointer",
                      fontSize: "0.875rem",
