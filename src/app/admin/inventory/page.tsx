            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '2rem' }}>
                <Card>
                    <CardContent style={{ padding: '1.5rem' }}>
                        <div style={{ fontSize: '0.875rem', color: '#6b7280', marginBottom: '0.5rem' }}>สต็อกพร้อมขาย</div>
                        <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#22c55e' }}>{totalAvailable}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardContent style={{ padding: '1.5rem' }}>
                ...
                <Card>
                    <CardContent style={{ padding: '1.5rem' }}>
                        <div style={{ fontSize: '0.875rem', color: '#6b7280', marginBottom: '0.5rem' }}>ขายไปแล้ว</div>
                        <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#3b82f6' }}>{totalSold}</div>
                    </CardContent>
                </Card>
                <Card style={{ borderColor: lowStockCount > 0 ? '#f59e0b' : '#e5e7eb' }}>
                    <CardContent style={{ padding: '1.5rem' }}>
                        <div style={{ fontSize: '0.875rem', color: '#6b7280', marginBottom: '0.5rem' }}>⚠️ สต็อกต่ำ</div>
                        <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#f59e0b' }}>{lowStockCount}</div>
                    </CardContent>
                </Card>
                <Card style={{ borderColor: outOfStockCount > 0 ? '#ef4444' : '#e5e7eb' }}>
                    <CardContent style={{ padding: '1.5rem' }}>
                        <div style={{ fontSize: '0.875rem', color: '#6b7280', marginBottom: '0.5rem' }}>❌ หมดสต็อก</div>
                        <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#ef4444' }}>{outOfStockCount}</div>
                    </CardContent>
                </Card>
            </div>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem' }}>
                        <button
                            ...
                            style={{
                                ...
                                border: filter === 'all' ? '2px solid #166534' : '1px solid #d1d5db',
                        ...
                        <button
                            ...
                            style={{
                                padding: '0.5rem 1rem',
                                borderRadius: '0.375rem',
                                border: filter === 'low' ? '2px solid #166534' : '1px solid #d1d5db',
                        ...
                        <button
                            ...
                            style={{
                                padding: '0.5rem 1rem',
                                borderRadius: '0.375rem',
                                border: filter === 'out' ? '2px solid #166534' : '1px solid #d1d5db',
                            ...
                            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '800px' }}>
                                <thead style={{ backgroundColor: '#f9fafb', borderBottom: '2px solid #e5e7eb' }}>
                                    <tr>
                                        ...
                                        <th style={{ padding: '1rem', textAlign: 'center', fontSize: '0.875rem', fontWeight: 600 }}>จัดการ</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {filteredTrees.map((tree) => {
                                        ...
                                        return (
                                            <tr key={tree.id} style={{ borderBottom: '1px solid #f3f4f6' }}>
                                                ...
                                                <td style={{ padding: '1rem', textAlign: 'center', color: '#6b7280' }}>{tree.sold}</td>
                                                <td style={{ padding: '1rem', textAlign: 'center' }}>
                                                    <span style={{
