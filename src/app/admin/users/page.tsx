...
export default function AdminUsersPage() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const filtered = allBookings.filter(
          (b: Booking & { userId: string }) => b.userId === userId,
        );
  ...
  const getRoleStyle = (role: string) => {
    if (role === "admin")
      return { bg: "#fee2e2", color: "#991b1b", label: "Admin" };
    if (role === "staff")
      return { bg: "#dbeafe", color: "#1e40af", label: "Staff" };
        ...
        >
          ...
          >
            ...
            <div
              style={{
                background:
                  "linear-gradient(135deg, #14532d 0%, #166534 45%, #15803d 75%, #22c55e 100%)",
                height: "145px",
                position: "relative",
                flexShrink: 0,
              }}
            ...
            {/* Body */}
            <div
              style={{ padding: "3.5rem 2rem 2rem 2rem", overflowY: "auto" }}
            >
              {/* Name & Role */}
              <div
                style={{
                  ...
                  >
                    ...
                    >
                      <thead style={{ backgroundColor: "#f9fafb" }}>
                        <tr>
                          {["รหัสออเดอร์", "วันที่", "ยอดรวม", "สถานะ"].map(
                            (h) => (
                              <th
                                key={h}
                                style={{
