...
export default function BestSellersPage() {
  ...
  const treeSales: Record<
    string,
    { name: string; count: number; revenue: number; images: string }
  > = {};
  ...
  const sortedTrees = Object.values(treeSales)
        ...
        <Card style={{ borderLeft: "4px solid #fbbf24" }}>
          ...
          <CardContent>
            ...
            <p style={{ fontSize: "0.75rem", color: "#6b7280" }}>
              {sortedTrees[0]?.count || 0} ต้น • ฿
              {(sortedTrees[0]?.revenue || 0).toLocaleString()}
            </p>
          </CardContent>
        </Card>
